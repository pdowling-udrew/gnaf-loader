...
update gnaf.address_principal_admin_boundaries
...
analyse gnaf.address_principal_admin_boundaries;


-- select count(*),
--        lga_name
-- from gnaf.address_principal_admin_boundaries
...
-- inner join gnaf.address_principal_admin_boundaries as bdy on bdy.gnaf_pid = gnaf.gnaf_pid
